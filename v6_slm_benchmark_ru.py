...
def run_slm_benchmark_ru():
    print("==================================================")
    print(" AGNIS V6.0 SLM PROTOTYPE (Russian language)")
    print("==================================================")
    
    # 1. Initialize Dataset & Vocabulary
    seq_length = 16
    batch_size = 16
    dataset = SLMDataset(filepath="slm/war_and_peace_ru.txt", seq_length=seq_length)
    ...
    # 3. Training Loop
    print(f"\\n[1/2] Online Learning Phase (Russian War & Peace - 20 Minutes)")
    batch_idx = 0
    ...
    generated_text = slm.generate(dataset.tokenizer, prompt=prompt, max_new_chars=50, temperature=0.8)
    
if __name__ == "__main__":
    run_slm_benchmark_ru()
