...
def get_data():
    ...
    print("[Data] Streaming FineWeb-Edu (50k samples, no disk cache)...")
    # streaming=True: downloads only what we read, no 30GB parquet cache
    ...
    print(f"[Data] Loaded {len(text)//1_000_000:.1f}M chars from {len(docs)} documents")
    return text
