...
def run_slm_benchmark():
    print("==================================================")
    print(" AGNIS V6.0 SLM PROTOTYPE (Character-Level)")
    print("==================================================")
    ...
    # 3. Training Loop
    print("\\n[1/2] Online Learning Phase (1st pass through Tiny Shakespeare chunk)")
    max_batches = 500  # Cap the training for prototype acid test (500 batches * 16 = 8000 chars)
    batch_idx = 0
    ...
    generated_text = slm.generate(dataset.tokenizer, prompt=prompt, max_new_chars=50)
