...
def main():
    ...
    print(f"\n  6. ZERO-FN THRESHOLD ({thresh_m1:.4f}) CLASSIFICATION METRICS (M1 Model):")
    print(f"     Confusion Matrix: TN={tn}, FP={fp}, FN={fn}, TP={tp}")
    print(f"     False Negatives Count (FN): {fn}")
